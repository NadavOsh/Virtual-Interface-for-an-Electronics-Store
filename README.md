...
This program was originally created for a "Lab for Advanced Programing in C" course in HIT. The instructions for this project can be found in "instructions" file. The project ended up with 100 points.
